...
class OrigamiNeutral extends StatefulWidget {
  @override
  _OrigamiNeutralState createState() => _OrigamiNeutralState();
}

class _OrigamiNeutralState extends State<OrigamiNeutral> {
  ...
  void generateRandomOrigamis() {
    List<String> origamis = ['Dog', 'Frog', 'Star', 'Elephant', 'Boat', 'Crane'];
    origamis.shuffle();
    isCheckedMap = {
      origamis[0]: false,
      origamis[1]: false,
