...
class HappyExercise extends StatefulWidget {
  @override
  _ExerciseHappyState createState() => _ExerciseHappyState();
}

class _ExerciseHappyState extends State<HappyExercise> {
  ...
  void generateRandomExercise() {
    List<String> exercise = ['Warrior Pose', 'Sun Salutation Pose', 'Happy Baby Pose', 'Corpse Pose', 'Bridge Pose', 'Tree Pose'];
    exercise.shuffle();
    isCheckedMap = {
      exercise[0]: false,
      exercise[1]: false,
  ...
  Widget buildExerciseWithCheckbox(String name) {
    String imagePath = 'image/${name.toLowerCase()}.jpg';
    return Row(
      children: [
        Checkbox(
