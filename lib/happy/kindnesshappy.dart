...
void main() {
  runApp(MaterialApp(
    home: KindnessJarScreen(),
  ));
}

class KindnessJarScreen extends StatefulWidget {
  @override
  _KindnessJarScreenState createState() => _KindnessJarScreenState();
}

class _KindnessJarScreenState extends State<KindnessJarScreen> {
