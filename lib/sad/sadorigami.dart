...
class OrigamiSad extends StatefulWidget {
  @override
  _OrigamiSadState createState() => _OrigamiSadState();
}

class _OrigamiSadState extends State<OrigamiSad> {
  ...
  void generateRandomOrigamis() {
    List<String> origamis = ['Dog', 'Pig', 'Fish', 'Tulips', 'Boat','Heart'];
    origamis.shuffle();
    isCheckedMap = {
      origamis[0]: false,
      origamis[1]: false,
